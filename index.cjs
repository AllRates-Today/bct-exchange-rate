'use strict';
// Central Bank of Tunisia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bct';
...
/** Latest rate for one pair, e.g. getRate('USD', 'TND', { apiKey }). */
